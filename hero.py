...
class Hero():
    ...
    def look_at(self,angle):
        '''возвращает координаты, в которые переместится персонаж, если он делает шаг в направлении angle(
            три скобы отображаются в информации об функции)'''
    ...
    def just_move(self,angle):
        '''перемещается в нужные коодинаты в любом случае'''
