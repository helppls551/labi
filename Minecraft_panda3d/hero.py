...
#         self.sm = loader.loadModel('smiley')
#         self.sm.setColor(0,0,0)
#         self.sm.setScale(0.1)
#         self.sm.setPos(pos)
#         self.sm.reparentTo(render)
class Smiley():
    ...
    def turn_left(self):
        self.hero.setH((self.hero.getH() + 1) % 360) 
    ...
    def right(self):
        ...
        self.hero.setR((self.hero.getR() + 5) % 360) 
        self.move_to(angle)
...
class Hero():
    def __init__(self, pos, land):
        self.land = land
        self.mode = True # режим прохождения сквозь всё
        self.hero = loader.loadModel('ship.egg')
        self.sm = loader.loadModel('smiley')
        # self.hero = loader.loadModel('12221_Cat_v1_l3.obj')
        # self.hero.setTexture(loader.loadTexture('Cat_bump.jpg')) 
        self.hero.setColor(1, 0.5, 0)
